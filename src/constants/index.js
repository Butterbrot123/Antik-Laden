...
export const navLinks = [
  ...
  { href: "/dienste", label: "Unsere Dienste" },
...
export const productsHomepage = [
  {
    imgURL: postcard,
    name: "Postkarten",
    description: "Wir sind interessert an Vintage-Postkarten mit einzigartiger historischer Bedeutung"
  },
  {
    imgURL: clock,
    name: "Uhren",
    description: "Antike Uhren, die Geschichten aus einer vergangenen Zeit erzählen.."
  },
  {
    imgURL: coins,
    name: "Münzen ",
    description: "Jede Münze erzählt ihre eigene Geschichte und trägt Spuren der Geschichte, Kultur und Kunst ihrer Zeit "
  },

  {
    imgURL: schmuck,
    name: "Schmuck ",
    description: "Schmuck ist nicht nur ein stilvolles Accessoire, sondern auch eine Ausdrucksform der Persönlichkeit. "
  },
...
export const products = [
  {
    imgURL: postcard,
    name: "Postkarten",
    description: "Wir kaufen ihre Postkarten und Ansichtskarten, beschrieben und Unbeschrieben. Auch größere Sammlungen möglichen."
  },
  {
    imgURL: coins,
    name: "Münzen ",
    description: "Wir kaufen Münzen, Mediallen, Einzelstücke bis zu großen Sammlungen und Nachlässen. Auch Einschätzung und Ankauf internationale Münzen sind bei uns möglich."
  },
...
export const services = [
  {
    imgURL: truckFast,
    label: "Bundesweiter Ankauf",
    subtext:
      "Wir stehen bereit, um Ihnen den bestmöglichen Service zu bieten, ganz gleich, wo Sie sich befinden..",
  },
  {
    imgURL: shieldTick,
    label: "Transparant und Fair",
    subtext:
      "Bei uns steht Fairness an erster Stelle, während wir Ihren Ankauf-Prozess so einfach und effizient wie möglich gestalten.",
  },
  {
    imgURL: support,
    label: "Jahrelanger Erfahrung",
    subtext:
      "Mit unserer jahrelangen Erfahrung bieten wir bewährte Kompetenz und Expertise, um Ihre Bedürfnisse zuverlässig zu erfüllen.",
  },
];
...
export const footerLinks = [
  {
    ...
    links: [
      { name: "Montag: 9:00-20:00" },
      { name: "Donnerstag: 9:00-20:00" },
      { name: "Samstag: 9:00-15:00" },
  ...
  },
  {
    title: "Kontakt",
    links: [
      { name: "Rathausstraße 3" },
      { name: "24960 Glücksburg" },
      { name: "andreasbrix@t-online.de" },
      { name: "0463-14449555" },
      { name: "0162-1003000" },
    ],
  },
